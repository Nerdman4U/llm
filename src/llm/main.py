...
"""
main.py
This is the main entry point for the llm Python application.
"""
...
from llm import __version_number__
# from src.llm.extension.my_module import MyClass
...
def register_module_spec() -> None:
    ...
    if str(spec.name).find('llm') < 0:
        raise ValueError(f'Package name is not "llm", name: {spec.name}')
