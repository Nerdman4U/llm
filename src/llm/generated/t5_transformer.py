...
class GeneratedInitializationParams(BaseModel):
    ...
    model_type: str = "AutoModelForSeq2SeqLM"
    tokenizer_type: str = "AutoTokenizer"


class T5Transformer(BaseTransformerAlias):
    """
    T5Transformer class is a generated class for llm project.
    ...
    def __init__(self, *args, **kwargs):
        """
        Initialize the T5Transformer class with given arguments.
        """
    ...
    def extension(self):
        """
        Get the extension of the T5Transformer.
    ...
    def __repr__(self) -> str:
        ...
        return f"T5Transformer({', '.join(self.attrs_to_string())})"
    ...
    @classmethod
    def from_dict(cls, *args, **kwargs) -> T5Transformer:
        """
