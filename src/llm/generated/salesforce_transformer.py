...
class GeneratedInitializationParams(BaseModel):
    ...
    SalesforceTransformer class.
    """
    transformers_model_name: str = "Salesforce/codegen-350M-mono"
    model_type: str = "AutoModelForCausalLM"
    tokenizer_type: str = "AutoTokenizer"


class SalesforceTransformer(BaseTransformerAlias):
    """
    SalesforceTransformer class is a generated class for llm project.
    ...
    def extension(self):
        """
        Get the extension of the SalesforceTransformer.
    ...
    def __repr__(self) -> str:
        ...
        return f"SalesforceTransformer({', '.join(self.attrs_to_string())})"
    ...
    @classmethod
    def from_dict(cls, *args, **kwargs) -> SalesforceTransformer:
        """
