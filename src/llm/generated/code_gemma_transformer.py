...
class GeneratedInitializationParams(BaseModel):
    ...
    CodeGemmaTransformer class.
    """
    transformers_model_name: str = "google/codegemma-2b"
    model_type: str = "AutoModelForCausalLM"
    tokenizer_type: str = "GemmaTokenizer"


class CodeGemmaTransformer(BaseTransformerAlias):
    """
    CodeGemmaTransformer class is a generated class for llm project.
    ...
    def extension(self):
        """
        Get the extension of the CodeGemmaTransformer.
    ...
    def __repr__(self) -> str:
        ...
        return f"CodeGemmaTransformer({', '.join(self.attrs_to_string())})"
