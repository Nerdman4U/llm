...
class GeneratedInitializationParams(BaseModel):
    ...
    BertTransformer class.
    """
    transformers_model_name: str = "bert-base-uncased"
    model_type: str = "BertModel"
    tokenizer_type: str = "BertTokenizer"


class BertTransformer(BaseTransformerAlias):
    """
    BertTransformer class is a generated class for llm project.
    ...
    def extension(self):
        """
        Get the extension of the BertTransformer.
    ...
    def __repr__(self) -> str:
        ...
        return f"BertTransformer({', '.join(self.attrs_to_string())})"
    ...
    @classmethod
    def from_dict(cls, *args, **kwargs) -> BertTransformer:
        """
